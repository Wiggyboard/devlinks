export default function Header({ selectedTab, setSelectedTab, setLastTab, setNotificationDisplay }) {
    ...
    return (
        <header>
            ...
            <div className="header-center">
                ...
                <button
                    className={`profile-details-tab header-tab header-tab${selectedTab === 'Profile' ? '-selected' : ''}`}
